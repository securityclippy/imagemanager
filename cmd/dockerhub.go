...
// dockerhubCmd represents the dockerhub command
...
func init() {
	...
	// dockerhubCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// dockerhubCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
